...
public class MoobloomsEntities {
	...
	public static final Moobloom DANDELION_MOOBLOOM = new Moobloom.Builder().name(Mooblooms.id("dandelion_moobloom")).blockState(Blocks.DANDELION.getDefaultState()).spawnEntry(new SpawnEntry(Mooblooms.config.dandelionMoobloom)).spawnPredicate(AnimalWithBlockState::canSpawn).spawnEgg(0xFED639, 0xFBEBAE).configCategory(Mooblooms.config.dandelionMoobloom).build();
	public static final Moobloom POPPY_MOOBLOOM = new Moobloom.Builder().name(Mooblooms.id("poppy_moobloom")).blockState(Blocks.POPPY.getDefaultState()).spawnEntry(new SpawnEntry(Mooblooms.config.poppyMoobloom)).spawnPredicate(AnimalWithBlockState::canSpawn).spawnEgg(0xBF2529, 0xFAB8B7).configCategory(Mooblooms.config.poppyMoobloom).build();
	...
	public static final Moobloom AZALEA_MOOBLOOM = new Moobloom.Builder().name(Mooblooms.id("azalea_moobloom")).blockState(Blocks.FLOWERING_AZALEA.getDefaultState()).blockStateRenderer(-0.5F, -0.5F, 0.5F, -0.5D, -1.0D, -0.5D).spawnEntry(new SpawnEntry(Mooblooms.config.azaleaMoobloom)).spawnPredicate(AnimalWithBlockState::canSpawn).spawnEgg(0x70922D, 0xBA62CE).configCategory(Mooblooms.config.azaleaMoobloom).build();
