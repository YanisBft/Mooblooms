...
public class Moobloom extends AbstractMoobloom {
	...
	private Moobloom(Moobloom.Builder settings) {
		...
		this.entityType = (EntityType<MoobloomEntity>) builder.build(key);
	...
	public static class Builder extends AbstractMoobloom.Builder {
		...
		/**
		 * Sets the block state related to this moobloom, from the world context.
		 * <p>Will appear on this moobloom's back and be randomly placed on valid blocks.</p>
		 * <p>The item matching the block state will be dropped when shearing this moobloom.</p>
		 * @param blockStateProvider a block state provider
		 * @return this builder for chaining
		 */
		public Moobloom.Builder blockState(Function<World, BlockState> blockStateProvider) {
		...
		public Moobloom build() {
			...
			checkState(this.blockStateProvider != null, "A block state is required to build a new moobloom.");
