...
public class Cluckshroom extends AbstractMoobloom {
	...
	public static class Builder extends AbstractMoobloom.Builder {
		 ...
		 * <p>
		 * Will appear on this cluckshroom's back and be randomly placed on valid
		 * blocks.
		 * </p>
		 * <p>
		 ...
		 * @return this builder for chaining
		 */
		public Cluckshroom.Builder blockStateRenderer(float scaleX, float scaleY, float scaleZ, double translationX,
		 ...
		 * @return this builder for chaining
		 */
		public Cluckshroom.Builder validBlocks(BlockTags blocks) {
		 ...
		 * <p>
		 * Defaults to {@linkplain net.minecraft.entity.passive.ChickenEntity chicken's}
		 * loot table.
		 * </p>
		 *
