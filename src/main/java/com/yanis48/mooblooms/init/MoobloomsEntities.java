...
public class MoobloomsEntities {
	...
	public static final EntityType<MoobloomEntity> POPPY_MOOBLOOM = register("poppy_moobloom", FabricEntityTypeBuilder.create(EntityCategory.CREATURE, MoobloomEntity::new).size(EntityDimensions.fixed(0.9F, 1.4F)).build());
	public static final EntityType<MoobloomEntity> BLUE_ORCHID_MOOBLOOM = register("blue_orchid_moobloom", FabricEntityTypeBuilder.create(EntityCategory.CREATURE, MoobloomEntity::new).size(EntityDimensions.fixed(0.9F, 1.4F)).build());
	public static final EntityType<MoobloomEntity> ALLIUM_MOOBLOOM = register("allium_moobloom", FabricEntityTypeBuilder.create(EntityCategory.CREATURE, MoobloomEntity::new).size(EntityDimensions.fixed(0.9F, 1.4F)).build());
	...
	public static final EntityType<MooshroomEntity> CRIMSON_MOOSHROOM = register("crimson_mooshroom", FabricEntityTypeBuilder.create(EntityCategory.CREATURE, MooshroomEntity::new).size(EntityDimensions.fixed(0.9F, 1.4F)).setImmuneToFire().build());
	public static final EntityType<MooshroomEntity> WARPED_MOOSHROOM = register("warped_mooshroom", FabricEntityTypeBuilder.create(EntityCategory.CREATURE, MooshroomEntity::new).size(EntityDimensions.fixed(0.9F, 1.4F)).setImmuneToFire().build());
